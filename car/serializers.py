...
class CarSerializer(serializers.Serializer):
    ...
    horse_powers = serializers.IntegerField(required=True, max_value=1914, min_value=1)
    ...
    def update(self, instance, validated_data):
        instance.manufacturer = validated_data.get("validated_data", instance.manufacturer)
